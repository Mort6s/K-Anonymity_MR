...
public GenTableDefinition_census_income(){};
	...
	public int getAttrRangeOrGenLevel(String sAttr){
		List<String> attQ = Arrays.asList(new String[]{"class_of_worker","education","marital_status","race","sex","country_of_birth_self","age"});
		int[] attQ_RangeOrGenLevel = {2,3,2,1,1,2,100};
		int i = 0;
